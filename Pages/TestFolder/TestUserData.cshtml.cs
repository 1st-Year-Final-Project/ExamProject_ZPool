...
namespace ZPool.Pages.TestFolder
{
    public class TestUserDataModel : PageModel
    {
        ...
        public IEnumerable<TestCar> Cars { get; set; } = new List<TestCar>();
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            AppUser = _userManager.Users.FirstOrDefault(u => u.Id == 1);

            
            Cars = _context.Cars.Where(c => c.UserId == AppUser.Id);
